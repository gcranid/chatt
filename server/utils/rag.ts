...
import {
  RecursiveUrlLoader,
  type RecursiveUrlLoaderOptions,
} from "@/server/utils/recursiveUrlLoader";
...
export const ingestDocument = async (
  ...
  console.log(
    `${docs.length} documents added to collection ${collectionName}.`,
  );
};
...
export const ingestURLs = async (
  ...
  const { pageParser, maxDepth, excludeGlobs } =
